...
(async () => {
  ...
  const title = await askQuestion(
    'Enter the app title (default: "DigitChat"): '
  );
  env['APP_TITLE'] = title || 'DigitChat';
  ...
  const mongodb = await askQuestion(
    'What is your mongodb url? (default: mongodb://127.0.0.1:27017/DigitChat)'
  );
  env['MONGO_URI'] = mongodb || 'mongodb://127.0.0.1:27017/DigitChat';
